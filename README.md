...
The repository treats academic reading as a structured research workflow rather than isolated summarization.
...
- causal inference reading workflows
- Bayesian paper analysis
- event history analysis workflows
- demographic theory mapping
- automated literature clustering
- research proposal generation support
